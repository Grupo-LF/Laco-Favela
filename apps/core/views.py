...
def lista_notificacoes(request):
    notificacoes_teste = [
        {"id": 1, "tipo": "reuniao", "titulo": "Reunião da comunidade", "mensagem": "Amanhã às 18h no Centro Comunitário.", "tempo_passado": "Hoje, 09:14", "lida": False},
        {"id": 2, "tipo": "status", "titulo": "Status Atualizado", "mensagem": "Sua situação foi atualizada para Aprovado.", "tempo_passado": "Ontem, 14:32", "lida": False},
        {"id": 3, "tipo": "acao", "titulo": "Nova Ação Disponível", "mensagem": "Uma nova ação está disponível.", "tempo_passado": "Ontem, 11:00", "lida": False},
        {"id": 4, "tipo": "palestra", "titulo": "Palestra: Direitos do Morador", "mensagem": "Evento na praça central às 16h.", "tempo_passado": "3 dias atrás", "lida": True},
